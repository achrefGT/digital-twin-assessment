#!/usr/bin/env python3
"""
Resilience Service Entry Point
"""
...
from services.sustainability.config import settings


def main():
    """Main entry point for the sustainability service"""
    ...
    uvicorn.run(
        "services.sustainability.app:app",  # String reference instead of importing app directly
