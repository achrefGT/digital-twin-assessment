...
class SustainabilitySettings(BaseSettings):
    """Sustainability service configuration settings"""
    
    model_config = SettingsConfigDict(
        env_file=".env",
        case_sensitive=False,
        env_prefix="SUSTAINABILITY_"  # Environment variables prefixed with SUSTAINABILITY_
    )
    
    # Service identity
    service_name: str = "sustainability-service"
    version: str = "0.1.0"
    ...
    kafka_consumer_group_id: str = "sustainability-service"
    ...
    sustainability_scale_min: int = 0
    sustainability_scale_max: int = 100
    dimension_weight_environmental: float = 0.4
    dimension_weight_economic: float = 0.3
    dimension_weight_social: float = 0.3
    ...
    def database_url(self) -> str:
        ...
        return get_database_url("sustainability")
    ...
    def get_topic_config(self) -> Dict[str, str]:
        ...
        return {
            "input": self.sustainability_submission_topic,
            "output": self.sustainability_scores_topic,
