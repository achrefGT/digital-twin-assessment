...
class ResilienceSettings(BaseSettings):
    """Resilience service configuration settings"""
    
    model_config = SettingsConfigDict(
        env_file=".env",
        case_sensitive=False,
        env_prefix="RESILIENCE_"  # Environment variables prefixed with RESILIENCE_
    )
    
    # Service identity
    service_name: str = "resilience-service"
    version: str = "0.1.0"
    ...
    kafka_consumer_group_id: str = "resilience-service"
    ...
    resilience_scale_min: int = 0
    resilience_scale_max: int = 100
    ...
    def get_topic_config(self) -> Dict[str, str]:
        ...
        return {
            "input": self.resilience_submission_topic,
            "output": self.resilience_scores_topic,
