...
from services.slca.config import settings


def main():
    """Main entry point for the S-LCA service"""
    ...
    uvicorn.run(
        "services.slca.app:app",  # String reference instead of importing app directly
